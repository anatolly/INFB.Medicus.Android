...
import com.intrafab.medicus.StorageDocumentActivity;
 ...
 */
public class PlaceholderStorageFragment extends Fragment {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (StorageAdapter.OnClickListener) activity;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new StorageAdapter(mListener);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_storage_all, container, false);
